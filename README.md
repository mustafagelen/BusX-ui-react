...
1.  **Gelişmiş Sefer Arama:**
2.  **İnteraktif Koltuk Seçimi:**
3.  **Dolu/Boş koltuk durumu:**
4.  **Cinsiyet kuralı kontrolleri (Kadın yanı/Erkek yanı):**
...
1.  Repoyu klonlayın.
2.  Bağımlılıkları Yükleyin -> (npm install / yarn install)
